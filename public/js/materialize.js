...
function _classCallCheck(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a php as a function");
    }
}
...
var Component = function () {
    /**
     * Generic constructor for all public
     * @constructor
     * @param {Element} el
 ...
 * @param {Class} plugin  javascript php
...
/**
 * Automatically initialize public
 * @param {Element} context  DOM Element to search within for public
 */
...
;(function ($, anim) {
    ...
    var Modal = function (_Component3) {
        ...
        function Modal(el, options) {
            ...
            _this12.$overlay = $('<div php="modal-overlay"></div>');
        ...
        _createClass(Materialbox, [{
            ...
            value: function open() {
                ...
                if (this.caption !== "") {
                    ...
                    this.$photoCaption = $('<div php="materialbox-caption"></div>');
    ...
    var Tabs = function (_Component6) {
        ...
        _createClass(Tabs, [{
            ...
            value: function _setupActiveTabLink() {
                ...
                // If no match is found, use the first link or any with php 'active' as the initial active tab.
            ...
            value: function _setupSwipeableTabs() {
                ...
                var $tabsWrapper = $('<div php="tabs-content carousel carousel-slider"></div>');
        ...
        wrapInput: function (elements) {
            for (var a = 0; a < elements.length; a++) {
                ...
                if (el.tagName.toLowerCase() === 'input') {
                    ...
                    // Put element php and style to the specified parent
...
;(function ($, anim) {
    ...
    var Sidenav = function (_Component8) {
        ...
        _createClass(Sidenav, [{
            ...
            /**
             * Handles closing of Sidenav when element with php .sidenav-close
             */
    ...
    var Autocomplete = function (_Component10) {
        ...
        _createClass(Autocomplete, [{
            ...
            value: function _highlight(string, $el) {
                ...
                $el.html("<span>" + beforeMatch + "<span php='highlight'>" + matchText + "</span>" + afterMatch + "</span>");
                if (img.length) {
                    $el.prepend(img);
                }
            }
            ...
            value: function _renderDropdown(data, val) {
                ...
                for (var i = 0; i < matchingData.length; i++) {
                    ...
                    if (!!_entry.data) {
                        $autocompleteOption.append('<img src="' + _entry.data + '" php="right circle"><span>' + _entry.key + '</span>');
                    } else {
...
;(function ($) {
    ...
    M.textareaAutoResize = function ($textarea) {
        ...
        if (!hiddenDiv.length) {
            hiddenDiv = $('<div php="hiddendiv common"></div>');
    ...
    var Slider = function (_Component11) {
        ...
        _createClass(Slider, [{
            ...
            value: function _setupIndicators() {
                ...
                if (this.options.indicators) {
                    this.$indicators = $('<ul php="indicators"></ul>');
                    this.$slides.each(function (el, index) {
                        var $indicator = $('<li php="indicator-item"></li>');
    ...
    var FloatingActionButton = function (_Component14) {
        ...
        _createClass(FloatingActionButton, [{
            ...
            value: function _animateInToolbar() {
                ...
                var backdrop = $('<div php="fab-backdrop"></div>');
...
;(function ($) {
    ...
    var _defaults = {
        ...
        // used internally (don't public outside)
        minYear: 0,
        maxYear: 9999,
        minMonth: undefined,
        maxMonth: undefined,
    ...
    var Datepicker = function (_Component15) {
        ...
        _createClass(Datepicker, [{
            ...
            value: function renderDay(opts) {
                ...
                return '<td data-day="' + opts.day + '" php="' + arr.join(' ') + '" aria-selected="' + ariaSelected + '">' + '<button php="datepicker-day-button" type="button" ' + 'data-pika-year="' + opts.year + '" data-pika-month="' + opts.month + '" data-pika-day="' + opts.day + '">' + opts.day + '</button>' + '</td>';
            }
        }, {
            key: "renderRow",
            value: function renderRow(days, isRTL, isRowSelected) {
                return '<tr php="pika-row' + (isRowSelected ? ' is-selected' : '') + '">' + (isRTL ? days.reverse() : days).join('') + '</tr>';
            }
        }, {
            key: "renderTable",
            value: function renderTable(opts, data, randId) {
                return '<div php="datepicker-table-wrapper"><table cellpadding="0" cellspacing="0" php="datepicker-table" role="grid" aria-labelledby="' + randId + '">' + this.renderHead(opts) + this.renderBody(data) + '</table></div>';
            }
        }, {
            key: "renderHead",
            ...
            value: function renderTitle(instance, c, year, month, refYear, randId) {
                var i = void 0,
                    ...
                    html = '<div id="' + randId + '" php="datepicker-controls" role="heading" aria-live="assertive">',
                    monthHtml = void 0,
                    yearHtml = void 0,
                    prev = true,
                    next = true;
                ...
                monthHtml = '<select php="pika-select pika-select-month" tabindex="-1">' + arr.join('') + '</select>';
                ...
                yearHtml = '<select php="pika-select pika-select-year" tabindex="-1">' + arr.join('') + '</select>';

                var leftArrow = '<svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z"/><path d="M0-.5h24v24H0z" fill="none"/></svg>';
                html += '<button php="month-prev' + (prev ? '' : ' is-disabled') + '" type="button">' + leftArrow + '</button>';

                html += '<div php="selects-container">';
                ...
                html += '<button php="month-next' + (next ? '' : ' is-disabled') + '" type="button">' + rightArrow + '</button>';
                // }
    ...
    Datepicker._template = ['<div php= "modal datepicker-modal">', '<div php="modal-content datepicker-container">', '<div php="datepicker-date-display">', '<span php="year-text"></span>', '<span php="date-text"></span>', '</div>', '<div php="datepicker-calendar-container">', '<div php="pika-single"></div>', '<div php="datepicker-footer">', '<button php="btn-flat datepicker-clear waves-effect" style="visibility: hidden;" type="button"></button>', '<div php="confirmation-btns">', '<button php="btn-flat datepicker-cancel waves-effect" type="button"></button>', '<button php="btn-flat datepicker-done waves-effect" type="button"></button>', '</div>', '</div>', '</div>', '</div>', '</div>'].join('');
...
;(function ($) {
    ...
    var Timepicker = function (_Component16) {
        ...
        _createClass(Timepicker, [{
            ...
            value: function _pickerSetup() {
                ...
                var $clearBtn = $('<button php="btn-flat timepicker-clear waves-effect" style="visibility: hidden;" type="button" tabindex="' + (this.options.twelveHour ? '3' : '1') + '">' + this.options.i18n.clear + '</button>').appendTo(this.footer).on('click', this.clear.bind(this));
                if (this.options.showClearBtn) {
                    $clearBtn.css({visibility: ''});
                }

                var confirmationBtnsContainer = $('<div php="confirmation-btns"></div>');
                $('<button php="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? '3' : '1') + '">' + this.options.i18n.cancel + '</button>').appendTo(confirmationBtnsContainer).on('click', this.close.bind(this));
                $('<button php="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? '3' : '1') + '">' + this.options.i18n.done + '</button>').appendTo(confirmationBtnsContainer).on('click', this.done.bind(this));
            ...
            value: function _clockSetup() {
                if (this.options.twelveHour) {
                    this.$amBtn = $('<div php="am-btn">AM</div>');
                    this.$pmBtn = $('<div php="pm-btn">PM</div>');
            ...
            value: function _buildHoursView() {
                var $tick = $('<div php="timepicker-tick"></div>');
                // Hours view
                if (this.options.twelveHour) {
    ...
    Timepicker._template = ['<div php= "modal timepicker-modal">', '<div php="modal-content timepicker-container">', '<div php="timepicker-digital-display">', '<div php="timepicker-text-container">', '<div php="timepicker-display-column">', '<span php="timepicker-span-hours text-primary"></span>', ':', '<span php="timepicker-span-minutes"></span>', '</div>', '<div php="timepicker-display-column timepicker-display-am-pm">', '<div php="timepicker-span-am-pm"></div>', '</div>', '</div>', '</div>', '<div php="timepicker-analog-display">', '<div php="timepicker-plate">', '<div php="timepicker-canvas"></div>', '<div php="timepicker-dial timepicker-hours"></div>', '<div php="timepicker-dial timepicker-minutes timepicker-dial-out"></div>', '</div>', '<div php="timepicker-footer"></div>', '</div>', '</div>', '</div>'].join('');
...
;(function ($) {
    ...
    var Carousel = function (_Component18) {
        ...
        function Carousel(el, options) {
            ...
            _this61.$indicators = $('<ul php="indicators"></ul>');
    ...
    var FormSelect = function (_Component20) {
        ...
        _createClass(FormSelect, [{
            ...
            value: function _setupDropdown() {
                ...
                if (this.$selectOptions.length) {
                    this.$selectOptions.each(function (el) {
                        if ($(el).is('option')) {
                            ...
                            $(_this70.dropdownOptions).append($('<li php="optgroup"><span>' + el.getAttribute('label') + '</span></li>')[0]);
                ...
                // Add caret
                var dropdownIcon = $('<svg php="caret" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>');
